  ...
  template: `
    ...
    <div class="panel-body" [dndList]="{
      ...
      <ng-container *ngIf="isArray(item)">
        ...
        <app-comp-container *ngIf="subItem.type === 'container'"
        [list]="item"
        [model]="subItem"></app-comp-container>
      ...
      <ng-container *ngIf="!isArray(item)">
        <app-comp-container *ngIf="item.type === 'container'"
          [list]="model.columns"
          [model]="item"></app-comp-container>
